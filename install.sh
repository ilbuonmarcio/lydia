...
arch-chroot /mnt echo "jacklnx" >> /mnt/etc/hostname

# setting hosts file
arch-chroot /mnt echo "127.0.0.1 localhost" >> /mnt/etc/hosts
arch-chroot /mnt echo "::1 localhost" >> /mnt/etc/hosts
arch-chroot /mnt echo "127.0.1.1 jacklnx.localdomain jacklnx" >> /mnt/etc/hosts
...
# configuring jacklnx boot entry
arch-chroot /mnt /bin/zsh -c "grep \"UUID=\" /etc/fstab | grep '/ ' | awk '{ print \$1 }' | sed -e 's/UUID=//' > .root_disk_uuid"
arch-chroot /mnt /bin/zsh -c 'touch /boot/loader/entries/jacklnx.conf'
arch-chroot /mnt /bin/zsh -c 'echo "title jacklnx" >> /boot/loader/entries/jacklnx.conf'
arch-chroot /mnt /bin/zsh -c 'echo "linux /vmlinuz-linux" >> /boot/loader/entries/jacklnx.conf'
arch-chroot /mnt /bin/zsh -c 'echo "initrd /amd-ucode.img" >> /boot/loader/entries/jacklnx.conf'
arch-chroot /mnt /bin/zsh -c 'echo "initrd /initramfs-linux.img" >> /boot/loader/entries/jacklnx.conf'
arch-chroot /mnt /bin/zsh -c 'echo options root=\"UUID=root_disk_uuid\" rw >> /boot/loader/entries/jacklnx.conf'
arch-chroot /mnt /bin/zsh -c 'sed -i -e "s/root_disk_uuid/$(cat .root_disk_uuid)/g" /boot/loader/entries/jacklnx.conf'
...
arch-chroot /mnt sudo -u jack /bin/zsh -c "cd /home/jack/yay_tmp_install && yes | makepkg -si"
arch-chroot /mnt rm -rf /home/jack/yay_tmp_install
...
arch-chroot /mnt sudo -u jack git clone https://github.com/VundleVim/Vundle.vim.git /home/jack/.config/nvim/bundle/Vundle.vim
...
arch-chroot /mnt sudo -u jack mkdir /home/jack/GitHub
arch-chroot /mnt sudo -u jack git clone https://github.com/GiacomoTezza/jacklnx /home/jack/GitHub/jacklnx
arch-chroot /mnt sudo -u jack /bin/zsh -c "chmod 700 /home/jack/GitHub/jacklnx/install_configs.sh"
arch-chroot /mnt sudo -u jack /bin/zsh -c "cd /home/jack/GitHub/jacklnx && ./install_configs.sh"

# create folder for screenshots
arch-chroot /mnt sudo -u jack mkdir /home/jack/Screenshots

# create pictures folder, secrets folder and moving default wallpaper
arch-chroot /mnt sudo -u jack mkdir /home/jack/Pictures/
arch-chroot /mnt sudo -u jack mkdir /home/jack/.secrets/
arch-chroot /mnt sudo -u jack mkdir /home/jack/Pictures/wallpapers/
