...
i3lock dbeaver ccache ttf-cascadia-code ttf-opensans httpie pavucontrol docker docker-compose picom mpv iotop bspwm sxhkd gitg filelight
...
arch-chroot /mnt sudo -u mrcz yay -S spotifyd-full-git ncspot --noconfirm
